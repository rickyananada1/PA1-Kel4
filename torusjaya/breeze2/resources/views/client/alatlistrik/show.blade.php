                            ...
                            <div class="col-lg-3 col-12">
                                <div class="custom-block-icon-wrap">
                                    <div class="custom-block-image-wrap custom-block-image-detail-page">
                                        <img src="{{ asset('images/alatlistrik/'.$peralatalistrik->image) }}"
                            ...
                            <div class="col-lg-9 col-12">
                                <div class="custom-block-info">
                                    <div class="custom-block-top d-flex mb-1">
                                        <small class="ms-auto">Stok <span class="badge">{{ $peralatalistrik->stok }}</span></small>
                                    </div>

                                    <h2 class="mb-2">{{ $peralatalistrik->name }}</h2>

                                    <p>{{ $peralatalistrik->description }}</p>
...
@php
  $peralatalistriks = App\Models\peralatalistrik::latest()->get();
@endphp
        <section class="topics-section section-padding pb-0" id="section_3">
            <div class="container">
                <div class="row">
                  ...
                  @foreach($peralatalistriks as $item)  

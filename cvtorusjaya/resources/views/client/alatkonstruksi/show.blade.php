...
<section class="latest-podcast-section section-padding pb-0" id="section_2">
            <div class="container">
                            ...
                            <div class="col-lg-3 col-12">
                                <div class="custom-block-icon-wrap">
                                    <div class="custom-block-image-wrap custom-block-image-detail-page">
                                        <img src="{{ asset('images/alatkonstruksi/'.$peralatankonstruksi->image) }}"
                            ...
                            <div class="col-lg-9 col-12">
                                <div class="custom-block-info">
                                    <div class="custom-block-top d-flex mb-1">
                                        <small class="ms-auto">Stok <span class="badge">{{ $peralatankonstruksi->stok }}</span></small>
                                    </div>

                                    <h2 class="mb-2">{{ $peralatankonstruksi->name }}</h2>

                                    <p>{{ $peralatankonstruksi->description }}</p>
                                    ...
                                    <div class="profile-block profile-detail-block d-flex flex-wrap align-items-center mt-5">
                                        <div class="d-flex mb-3 mb-lg-0 mb-md-0">
                                            ...
                                            <div class="ms-3">
                                                ...
                                                <br>
                                                <form method="POST"
                                                    action="{{ route('peralatankonstruksi.komentar.store', $peralatankonstruksi->id) }}">
                                                    @csrf
                                                    <div class="mb-3">
                ...
                <ul class="list-group">
                    @foreach($alat_konstruksi as $rowkonstruksi)
                        <li class="list-group-item">
                            {{ $rowkonstruksi->user ? $rowkonstruksi->user->name : 'Pengguna Tidak Diketahui' }}
                            <textarea class="form-control" name="komentar" id="komentar" rows="3" disabled style="border:none;">{{ $rowkonstruksi->komentar }}</textarea>
...
@php
  $peralatankonstruksis = App\Models\peralatankonstruksi::latest()->get();
@endphp
